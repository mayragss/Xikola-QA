        ...
        <div class="row mb-4">
                                ...
                                {{$users[$member]->first_name[0]}}{{$users[$member]->last_name[0]}}
                                        ...
                                        <div class="ms-auto">
                                            @if($project->status == 'Started')
                                                <span class="badge bg-label-primary"> {{__('Started')}}</span>

                                            @elseif($project->status == 'Pending')
                                                <span class="badge bg-label-yellow">{{__('Pending')}}</span>
                                            @elseif($project->status == 'Finished')
                                                <span class="badge bg-label-success">{{__('Finished')}}</span>
                                            @endif
            ...
            <div class="col-md-4">
                ...
                <span class="text-dark">{{$todo->title}}</span>
                                        @if($todo->status == 'High')
                                                <span class="badge bg-label-danger"> {{__('High')}}</span>

                                            @elseif($todo->status == 'Medium')
                                                <span class="badge bg-label-yellow">{{__('Medium')}}</span>
                                            @elseif($todo->status == 'Low')
                                                <span class="badge bg-label-success">{{__('Low')}}</span>
                                            @endif
                                    </span>
                                    </label>
                                </div>
